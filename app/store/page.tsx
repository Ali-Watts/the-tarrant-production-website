      ...
      <section className="py-24 px-6" style={{ background: 'var(--bg-secondary)' }}>
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col gap-6">
            ...
            <p style={{ fontSize: '1.1rem', color: 'var(--clr-accent)' }}>$599 AUD</p>
            <EcwidProduct productId={828421001} productName="Midnight" />
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6" style={{ background: 'var(--bg-warm)' }}>
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="flex flex-col gap-6 order-2 md:order-1">
            ...
            <p style={{ fontSize: '1.1rem', color: 'var(--clr-accent)' }}>$599 AUD</p>
            <EcwidProduct productId={828250988} productName="Slate" />
          </div>
      ...
      <section className="py-24 px-6" style={{ background: 'var(--bg-accent)' }}>
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col gap-6">
            ...
            <p style={{ fontSize: '1.1rem', color: 'var(--clr-accent)' }}>$599 AUD</p>
            <EcwidProduct productId={828245250} productName="Natural" />
          </div>
        </div>
      </section>
    </>
